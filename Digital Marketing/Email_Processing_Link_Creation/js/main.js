    ...
    {  
     ...
     function link() {
        ...
        if(box_index<a_close_index) {
            ...
            var flash_box_index=data.indexOf("flash_box_");
            if(flash_box_index<box_index&&flash_box_index!=-1) {
                plu_data_index=parseInt(plu_data_index);
                plu_data_index += 188; 
            ...
            if(img_index==-1){
                img_index=data.indexOf('<img')
                if(img_index==-1){
            process_data+=data;
            break;
            }
            else
                process_data=process_data.substring(0,process_data.length-1);
        }
