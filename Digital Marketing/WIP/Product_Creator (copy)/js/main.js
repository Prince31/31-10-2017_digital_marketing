...
function clear() {
   ...
   //       }
        ...
        $("#wit_box_submit_btn").bind("click", function() {
          ...
          if(wit_box_data!="")
          document.getElementById("wit_box_template").innerHTML = '<div id="in_box" class="toplevel"><div class="header">What&#39;s in the Box</div><ul>'+
            wit_box_data+'</ul></div>';
            else
        ...
        $("#requirement_submit_btn").bind("click", function() {
          ...
          if(requirement_data!="")
          document.getElementById("requirement_template").innerHTML = '<div id="in_box" class="toplevel"><div class="header">Requirements</div><ul>'+
            requirement_data+'</ul></div>';
            else
