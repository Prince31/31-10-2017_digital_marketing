...
function clear() {
   ...
   //       }
        ...
        $("#specification_submit_btn").bind("click", function() {
          ...
          if(spec_data!="")
          document.getElementById("specification_template").innerHTML = '<div id="#specifications" class="toplevel"><div class="header">Specifications</div><table class="specifications"><tbody>'+
            spec_data+
           '</tbody></table></div>';
           else
            document.getElementById("specification_template").innerHTML ="";
...
function imageCrop() {
    ...
    function scaleImage() {
      if(virtual_height>=virtual_width)
        ...
        virtual_width =0.0 + ratio * virtual_width;
        virtual_height =0.0 + ratio * virtual_height;      
    }
...
function saveData() {
  ...
  function oneCol() {
      ...
      display_arr[col_max] += '<div class="onecol even horizontal clearfix"><div class="header">'+col_max+' - '+pop_data[col_max][0] +'</div><img id="image_clip" src="'+pop_data[col_max][2] +'" style="border: 1px solid black"/><div class="body"><div class="text">'+pop_data[col_max][1] +'</div></div></div>' ;
  ...
  function display() {
    ...
    // document.getElementById("image_clip").style.clip = "rect(0px 300px 400px 0px)";
    col_no_field.setAttribute("max",col_max);
