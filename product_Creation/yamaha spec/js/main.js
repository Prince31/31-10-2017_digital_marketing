...
function dataCollection() {
  ...
  for(var i = 0; i < html_data.length; i++) {
    if(html_data.substring(i, i+22) == "activeo") {
    
      for(var i0 = i+7; i0 < html_data.length; i0++) {
        
        if(html_data.substring(i0, i0+33) ==
         '<th colspan="3" aria-hidden="true" style="">') {
          
        
          i0+=33;

           if(html_data.substring(i0, i0+5) != '</th>')
             track_value += '<thead>\n\t<tr>\n\t\t<td colspan="2"><tr>' +
              html_data.substring(i0, i0+1); +
             '</td>\n\t\t</tr>\n\t</thead>\n\t<tbody>';
          ...
          if(html_data.substring(i0, i0+52) ==
         '<th class="active" scope="row" rowspan="3" style="">') {
            i0+=52;
